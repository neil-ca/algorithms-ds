...
func (transaction *Transaction) create(srcAccountId string, descAccountId string, amount float32) *Transaction {
	fmt.Println("creating transaction")
	transaction.srcAccountId = srcAccountId
	transaction.destAccountId = descAccountId
...
func (facade *BranchManagerFacade) createCustomerAccount(customerName string,
